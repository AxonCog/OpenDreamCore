...
/**
 * neoforge-1.21.11 的桥总实现：TargetBridges 契约缺一不行——接口加方法这文件就得跟着
 * 加，漏了直接编译红，全版本对齐从结构上兜底。
 */
public final class NeoForge12111Bridges implements TargetBridges {
    ...
    private static final ResourcePackInjector INJECTOR = new com.opendreamcore.client.NeoForgePackInjector();
